...
INSERT INTO `problem` (`id`, `user_id`, `title`, `content`, `phone`, `block_id`, `depart_id`, `fb_content`, `star`, `state`, `reason`, `result`, `total_bill`, `total_time`, `realName`) VALUES
(1, 2, 'test01', 'test01', '13944097701', 25, 3, NULL, NULL, 1, NULL, NULL, NULL, NULL, 'test'),
(2, 2, 'test02', 'test02', '13944097701', 26, 3, NULL, NULL, 2, NULL, NULL, NULL, NULL, 'test'),
(3, 2, '第一卷 魔鬼训练营 第二章 失败者的惩罚', '1. 熟悉 ubuntu 系统。\n\n一般用 Ubuntu 的用户是刚从 windows 下过来的，用着可能各种不爽，但是请不要着急，慢慢会感觉爽的。\n\n2. 选择一个好的源，更新系统。\n\n你可能不知到什么是源，不过没关系。\n请更新源。不会的可以 google.\n\n3.视频软件\n	mplayer\n	\n4.音乐播放器\n	audacious\n\n5.BT下载\n	deluge\n	', '13944097701', 21, 1, NULL, NULL, 6, NULL, NULL, NULL, NULL, 'test'),
(4, 6, '管理员也要提问题', '管理员也要提问题', '13944097701', 20, 1, NULL, NULL, 2, NULL, NULL, NULL, NULL, 'test');
